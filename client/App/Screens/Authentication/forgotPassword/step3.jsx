        ...
        <TouchableOpacity style={{ flex: 1 }}>
          <View style={{ justifyContent: 'center', alignItems: 'center', width, height, gap: 40 }}>
            ...
            <View>
                ...
                <View style={{ gap: 20, justifyContent: 'center', alignItems: 'center' }}>
                  <View onPress={Keyboard.dismiss} style={Styles.loginContainer}>
                    ...
                    <TouchableOpacity style={{ right: 28 }} onPress={() => setShown(!shown)}>
                      {shown ? <Feather size={20} name="eye" /> : <Feather size={20} name="eye-off" />}
                    </TouchableOpacity>
                  </View>
                  <View onPress={Keyboard.dismiss} style={Styles.loginContainer}>
                    <Ionicons style={Styles.loginIcon} name="key-outline" size={20} color={'#8244CB'} />
                    ...
                    <TouchableOpacity style={{ right: 28 }} onPress={() => setShown2(!shown2)}>
                      {shown2 ? <Feather size={20} name="eye" /> : <Feather size={20} name="eye-off" />}
                    </TouchableOpacity>
                  </View>
                </View>
              ) : (
              ...
              {error === 'pass' && (
                <Text style={{ alignSelf: 'flex-end', color: 'red' }}>Confirmed Password is wrong</Text>
              )}
            </View>
            {!success ? (
              <TouchableOpacity
              ...
              >
                <Text style={{ color: 'white', fontFamily: 'Roboto-bold', fontSize: STYLES.SIZES.sizeL }}>Continue</Text>
              </TouchableOpacity>
            ) : (
              <TouchableOpacity
              ...
              >
                <Text style={{ color: 'white', fontFamily: 'Roboto-bold', fontSize: STYLES.SIZES.sizeL }}>Go Home</Text>
              </TouchableOpacity>
            )}
          </View>
        </TouchableOpacity>
