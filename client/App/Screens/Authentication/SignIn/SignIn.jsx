...
import { SignInFetch } from './fethcer';
...
export default function SignIn({navigation}) {
    ...
    const submit = async ()=>{ const res = await SignInFetch({email:email,password:password,role:pressed},navigation,setToken)
    if (res !== 'success'){
        Vibration.vibrate()
    }
   setError(res);
            ...
            <SafeAreaView style={{ justifyContent: 'center',
                ...
                <View style={{
                    ...
                    <View style={{ width: 300, top: 20, height: 200 }}>
                        ...
                        <Text style={{ fontFamily: "Roboto-Light", fontSize: STYLES.SIZES.sizeL, fontWeight: '100' }}>Please sign in to continue</Text>
                    </View>
                   ...
                   <Text style={{color:'white', fontFamily:'Roboto-bold', fontSize: STYLES.SIZES.sizeL}}>Sign In with google</Text>
                        </View>
                    </TouchableOpacity>
                        </View>
                </View>
